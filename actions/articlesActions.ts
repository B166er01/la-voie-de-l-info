...
export const increaseViewsById = async (
  id: string
...
export const createAuthor = async () => {
  ...
  try {
    const newAuthor = await Author.create({
      name: 'John Doe',
      image:
        'https://res.cloudinary.com/dos8mey8r/image/upload/v1708205392/LeCanard/cute-arctic-mammal-walking-frozen-ice-generated-by-ai_2_faukim.jpg',
      articles: [],
    })
    return true
  } catch (err) {

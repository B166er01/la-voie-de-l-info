  ...
  try {
    ...
    if (existingVisitor) {
      ...
      const timeDifference =
        currentTime.getTime() - existingVisitor.lastIncremented.getTime()
      ...
      if (hoursDifference >= 24) {
        ...
        console.log(
          'Reset countOfViews and lastIncremented for existing visitor:',
          existingVisitor
        )
        ...
        await existingVisitor.save()
        console.log(
          'Incremented countOfViews for existing visitor:',
          existingVisitor
        )
      } else {
        // countOfViews is already 3 or more, no further increment
        console.log(
          'countOfViews is already 3 or more for existing visitor:',
          existingVisitor
        )

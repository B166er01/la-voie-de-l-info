...
const Footer = () => {
  return (
    <footer className="relative pt-48 pb-6 w-full">
          ...
          <div className="w-full px-4">
            ...
            <div className="mt-6 mb-6 lg:mb-0">
              <div className="flex gap-6">
                ...
                <div className="w-9 h-9 bg-primaryBlue  hover:bg-opacity-90 rounded-lg flex items-center justify-center">
                  <Link
                    href={'/#'}
                    className="w-6 h-6  rounded-full  text-white transition-all cursor-pointer"
                  >
                    <svg
                      role="img"
                      viewBox="0 0 24 24"
                ...
                <ul className="">
                  <li>
                    <Link
                      ...
                      href="https://www.freeprivacypolicy.com/live/134d6928-9c0c-4109-8392-60fc987bb41d"
                    >
                      Politique Privée
                    </Link>
                  </li>

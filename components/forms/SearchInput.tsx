  ...
  return (
    <form onSubmit={(e) => handleSubmit(e)} className="w-full">
      <div className="relative mt-3">
        ...
        <label
          htmlFor="search"
          className="absolute z-20 px-1 text-4xl capitalize transition-all bg-white text-primaryGray left-2 peer-placeholder-shown:top-3 peer-focus:-top-2 -top-2 peer-placeholder-shown:text-sm peer-focus:text-xs peer-focus:text-primaryBlue peer-placeholder-shown:-z-10 peer-focus:z-20"
        >
          Search
        </label>
      </div>
